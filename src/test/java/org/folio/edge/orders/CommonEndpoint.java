...
public enum CommonEndpoint {
  ...
  ACQUISITIONS_METHODS("/acquisition-methods", "/orders/acquisition-methods", "acquisitionMethods", true, true),
  ORGANIZATIONS("/organizations", "/organizations/organizations", "organizations", true, true),
  BILLING_AND_SHIPPING("/addresses/billing-and-shipping", "/configurations/entries", "configs", true, false),
